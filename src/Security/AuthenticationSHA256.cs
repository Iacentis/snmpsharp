...
public class AuthenticationSHA256 : IAuthenticationDigest
{
    ...
    public static AuthenticationSHA256 Instance { get; } = new();
    /// <summary>
    ///     Standard constructor.
    /// </summary>
    private AuthenticationSHA256()
    {
    }
    ...
    public byte[] ComputeHash(ReadOnlySpan<byte> data, int offset, int count) => SHA256.HashData(data.Slice(offset, count));
}